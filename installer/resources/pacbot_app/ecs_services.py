...
class NginxEcsService(ECSServiceResource, BaseEcsService):
    name = "webapp"
...
class ConfigEcsService(ECSServiceResource, BaseEcsService):
    name = "config"
...
class AdminEcsService(ECSServiceResource, BaseEcsService):
    name = "admin"
...
class ComplianceEcsService(ECSServiceResource, BaseEcsService):
    name = "compliance"
...
class StatisticsEcsService(ECSServiceResource, BaseEcsService):
    name = "statistics"
...
class AssetEcsService(ECSServiceResource, BaseEcsService):
    name = "asset"
...
class AuthEcsService(ECSServiceResource, BaseEcsService):
    name = "auth"
